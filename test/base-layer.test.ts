 ...
 * lookbehind keeps `.dp-table tbody tr` and `.dp-gap__body` from matching: those are the selectors
 * already in this stylesheet that end in the four letters being searched for.
 */
