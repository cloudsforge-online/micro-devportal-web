 ...
 * (`devplatform/src/server.ts:604`), `GET /v1/apps` (`:1022`) and `GET /v1/apps/:slug` (`:1027`)
 ...
 * security boundary**: `devplatform` verifies the bearer itself (`devplatform/src/server.ts:461`),
 * asks identity for the caller's role per request (`:558`), and answers 404 rather than 403 for an
 * organisation or project the caller may not see (`:546`, `:520`).
 */
