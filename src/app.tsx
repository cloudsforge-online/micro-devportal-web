 ...
 * (`devplatform/src/server.ts:712`), `GET /v1/apps` (`:1263`) and `GET /v1/apps/:slug` (`:1291`)
 ...
 * security boundary**: `devplatform` verifies the bearer itself (`devplatform/src/server.ts:524`),
 * asks identity for the caller's role per request (`:666`), and answers 404 rather than 403 for an
 * organisation or project the caller may not see (`:654`, `:628`).
 */
